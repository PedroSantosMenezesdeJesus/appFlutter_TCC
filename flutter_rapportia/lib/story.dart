                    ...
                    children: [
                     ...
                     Center(          
                        child: RichText(
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(text: "A última", style: TextStyle(fontFamily: 'Sunshiney', fontSize: 96, color:Color.fromRGBO(0, 0, 0, 1))),             
                              TextSpan(text: "\nLuz", style: TextStyle(fontFamily: 'Sunshiney', fontSize: 96, color:Color.fromRGBO(241, 191, 39, 1)))
                            ]
                          )
                        ),
                      )
