                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('PERSONAGENS', style: TextStyle(fontFamily: 'Sunshiney', fontSize: 36, color:Color.fromRGBO(0, 0, 0, 1))),
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  ...
                                  child: Image.asset(personagem[index].img, width: 300, height: 200, fit: BoxFit.cover),
                                ),

                                Text(personagem[index].nome, style: TextStyle(color: Color.fromRGBO(0, 0, 0, 1), fontFamily: 'Sunshiney', fontSize: 24),),   
                              ],
                            );
                          },
                        ),
